...
//      Future.delayed(Duration.zero, () => this._showAppInfoDialog(context));
  ...
  Widget _buildCardRowNav(BuildContext context, String image) {
    return Expanded(
      ...
      child: GestureDetector(
          onTap: () {
            AppRoute.goToWebPage(
                context, "Facebook", "https://web.facebook.com/tamanborneo");
          },
          child: Padding(
  ...
  Widget _buildCardMap(BuildContext context) {
    return GestureDetector(
        child: Container(
          padding:
              EdgeInsets.only(left: 4.0, right: 4.0, top: 6.0, bottom: 4.0),
          child: ClipRRect(
  ...
  void _showAppInfoDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(Strings.profileDialogAboutTitle,
              style: TextStyle(
